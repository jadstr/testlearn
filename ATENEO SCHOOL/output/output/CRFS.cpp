...
cout << "Input your grade (CFRS): "; // Asks for the Computed Final Raw Score
cin >> raw; // raw as the variable for CFRS
...
else if (raw <= -1){ // same as the previous one but for negative numbers
    cout <<"Invalid CFRS";
    return 0;
}
